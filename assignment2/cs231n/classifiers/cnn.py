...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['W2'] = weight_scale * np.random.rand(((H/2) * (W/2) * num_filters), hidden_dim)
  ...
  def loss(self, X, y=None):
    ...
    out2, cache_affi = affine_relu_forward(out1, W2, b2)
    ...
    dx2, grads['W2'], grads['b2'] = affine_relu_backward(dx3, cache_affi)
